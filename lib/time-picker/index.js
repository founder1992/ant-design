...
var TimePicker = function (_React$Component) {
    ...
    TimePicker.prototype.getLocale = function getLocale() {
        ...
        // 统一合并为完整的 Locale
        return (0, _objectAssign2["default"])({}, locale, this.props.locale);
    };
    ...
    TimePicker.prototype.render = function render() {
        ...
        return React.createElement(_TimePicker2["default"], _extends({}, props, { className: className, locale: locale, formatter: this.getFormatter(), onChange: this.handleChange }));
    };
